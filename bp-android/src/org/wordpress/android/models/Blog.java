...
public class Blog {
    ...
    public Blog(int blog_id) throws Exception{
        ...
        List<Object> blogVals = MainActivity.wpDB.loadSettings(blog_id);
    ...
    public void save(String originalUsername) {
        //save blog to db
        MainActivity.wpDB.saveSettings(String.valueOf(this.id), this.url, this.homeURL, this.username, this.password, this.httpuser, this.httppassword, this.imagePlacement, this.featuredImageCapable, this.fullSizeImage, this.maxImageWidth, this.maxImageWidthId, this.location, this.dotcomFlag, originalUsername, this.postFormats, this.dotcom_username, this.dotcom_password, this.api_blogid, this.api_key, this.scaledImage, this.scaledImageWidth, this.blogOptions );
    }
    ...
    public int getUnmoderatedCommentCount() {
        return MainActivity.wpDB.getUnmoderatedCommentCount(this.id);
    }
