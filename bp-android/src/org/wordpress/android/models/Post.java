...
public class Post {
    ...
    public Post(int blog_id, long post_id, boolean isPage) {
        ...
        List<Object> postVals = MainActivity.wpDB.loadPost(blog_id, isPage, post_id);
        if (postVals != null) {
            try {
    ...
    public boolean save() {
        long newPostID = MainActivity.wpDB.savePost(this, this.blogID);
    ...
    public boolean update() {
        int success = MainActivity.wpDB.updatePost(this, this.blogID);
    ...
    public void delete() {
    	...
    	MainActivity.wpDB.deletePost(this);
    }

    public void deleteMediaFiles() {
    	MainActivity.wpDB.deleteMediaFilesForPost(this);
    }
